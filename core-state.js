...
function ug28BuildDivide() {
    ...
    var deco = [
        ...
        [10, 106, 'm'], [10, 112, 'S'], [10, 118, 'd'], [10, 128, 'S'], [10, 136, 'v'],
        [10, 140, 'm'], [10, 146, 'v'],
    ...
    //   3行掘れば地形に穴が空くので 'm'/'S' の穴回避が効き、見た目も他の部屋の溶岩と同じ深さになる。
    //   ⚠行14以降は岩のまま＝**上ルートの床は依然として塞がっており下ルートへは落ちられない**。
    var LAVA = [[11, 13, 66, 67], [11, 13, 88, 89], [11, 13, 110, 111], [11, 13, 132, 133]];

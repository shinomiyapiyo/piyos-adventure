...
var UG21_ROOM_RIFT = [].concat(
    ...
    [ugRow(152, ' ', [[45, 'o']])],                                         // 16   落下線のコイン
    ugRows(3, 152, ' '),                                                    // 17-19
    [ugRow(152, ' ', [[46, 'o']])],                                         // 20   落下線のコイン
    [ugRow(152, ' ', [[124, '=====']])],                                    // 21   合流の階段D2
    ugRows(2, 152, ' '),                                                    // 22-23
    [ugRow(152, ' ', [[45, 'o']])],                                         // 24   落下線のコイン
    ugRows(2, 152, ' '),                                                    // 25-26
    [ugRow(152, ' ', [[130, '=====']])],                                    // 27   合流の階段D3
    [ugRow(152, ' ', [[46, 'o']])],                                         // 28   落下線のコイン
    [ugRow(152, ' ')],                                                      // 29
...
// そのラウンドで使う部屋の並びを返す（1.599／1.610でR21を追加）。⚠**総幅はどれも790タイル**なので、
// どれを選んでもカメラ走行(UG_TRAVEL_PX)も距離加算も変わらない＝ランキングの前提は不変。
// R7=1周目／R14=2周目／R21以降=3周目（4周目以降も当面R21を使い回す）。

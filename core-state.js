...
const UG_BOSS_DEFEAT_FRAMES= 120;  // ⑤撃破演出→退場
// 仮ボスの調整ノブ。⚠P3で「闇の巫女」本実装に差し替える（SPEC §7）。ここは**闘技場が成立するかの検証用**。
const UG_BOSS_HP           = 100;
const UG_BOSS_STOMP_DMG    = 10;
...
var undergroundState = {
    ...
    boss: null            // 仮ボス {x,y,width,height,hp,maxHp,vx,phase}
};
...
var UG_ROOM_FORGE = [].concat(
    ...
    [ugRow(175, ' ', [[31, 'f'], [63, 'e'], [81, 'f'], [127, 'f'], [143, 'e'],
                      [22, 'm'], [42, 'v'], [55, 'S'], [72, 'v'], [95, 'm'],
                      [120, 'm'], [136, 'S'], [152, 'v'], [168, 'm']])],
    // 12: 床。溶岩の池（跳ぶ穴はすべて2〜3タイル）
    [ugRow(175, '#', [[14, 'LL'], [30, 'LLL'], [48, 'LL'], [62, 'LLL'], [80, 'LLL'], [96, 'LL'],
                      [112, 'LL'], [126, 'LLL'], [142, 'LLL'], [158, 'LL']])],
    ugRows(2, 175, '#', [[14, 'LL'], [30, 'LLL'], [48, 'LL'], [62, 'LLL'], [80, 'LLL'], [96, 'LL'],
                         [112, 'LL'], [126, 'LLL'], [142, 'LLL'], [158, 'LL']])
);
...
var UG_ROOM_GATE = [].concat(
    ...
    [ugRow(147, ' ', [[112, 'bbbb'], [120, 'bbbbbb'], [128, 'bbbbbbbbbbbbbbbbbbb']])], // 5 門のまぐさ
    ugRows(2, 147, ' ', [[122, 'bb'], [128, 'bb'], [145, 'bb']]),           // 6-7 門柱
    [ugRow(147, ' ', [[30, 'o'], [31, 'o'], [32, 'o'], [88, 'o'], [89, 'o'],
                      [122, 'bb'], [128, 'bb'], [145, 'bb']])],             // 8
    ugRows(2, 147, ' ', [[122, 'bb'], [128, 'bb'], [145, 'bb']]),           // 9-10
    // 11: 'W' = 怪しい老婆の店（洞窟の入口・未実装なので今は何も出ない）。
    //     'i' = 紫の燭台。⚠**門へ近づくほど間隔を詰める**（32→24→16→12→8タイル）＝
    //     「奥へ行くほど何かが祀られている」＝ボスの予告になる。数を増やすより**間隔の変化**が効く。
    [ugRow(147, ' ', [[128, 'bb'], [145, 'bb'], [18, 'S'], [40, 'W'], [50, 'c'], [80, 'v'], [104, 'c'],
                      [62, 'i'], [86, 'i'], [102, 'i'], [110, 'i'], [116, 'i'], [120, 'i'],
                      [124, 'i'], [127, 'i'], [131, 'i'], [134, 'i'], [137, 'i'], [140, 'i'], [143, 'i']])],
    [ugRow(147, '#')],                                                      // 12 床
    ugRows(2, 147, '#')                                                     // 13-14 詰め物
);
